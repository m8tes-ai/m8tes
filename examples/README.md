...
| File | What it shows |
|------|---------------|
| [`demo.py`](./demo.py) | Full setup in one script: create an agent, schedule it, add an email inbox, run it live |
...
| [`imessage-bluebubbles.py`](./imessage-bluebubbles.py) | Configure an agent to receive Apple Messages via BlueBubbles |
